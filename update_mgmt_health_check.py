...
def main(output_path=None, return_json_output="False"):
    ...
    if not ((sys.version_info[0] == 2) and ((sys.version_info[1]>=4) and (sys.version_info[1] < 8))):
        log_msg = "Unsupport python version:(%s). Supported python version (2.4 to 2.7)" % str(sys.version_info)
        print log_msg
        exit()
...
def check_os_version():
    ...
    # We support (Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, SuSE 11, SuSE 12, Redhat 6, Redhat 7, CentOs 6, CentOs 7)
